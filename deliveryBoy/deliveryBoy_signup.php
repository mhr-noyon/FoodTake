...
<body>
     ...
     <div class="main bg-image">
          <div class="login-form ">
               <h3 class="text-center text-decoration-underline">Stalf Sign-Up</h3>
               <form action="deliveryBoy_signup_check.php" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="go-signup">
                         ...
                         <a href="deliveryBoy-login.php">Log-In</a>
                    </div>
          </div>
     </div>
